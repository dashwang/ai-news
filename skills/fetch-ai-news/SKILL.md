...
- **新增全文置顶：标题对应的内容，放在全文第一篇的位置**
- **新增各板块置顶：每个板块的标题对应内容，排序到该板块开头**
...
- [ ] 标题加粗（color: #1a1a1a）
- [ ] **去重：检查是否已在之前发布过**
- [ ] **热标题内容置顶：与动态标题相关的内容放在全文第一篇 + 各板块开头**
...
**解决**：把与动态标题最相关的内容，**放到全文第一篇的位置**。

### 置顶规则：

1. **全文置顶**：动态标题对应的内容，放在**整个正文的最前面**（开场白之后、4个板块之前）
2. **各板块置顶**：每个板块中与该板块标题最相关的内容，排序到该板块的最前面
...
--- 🔥 全
文置顶 ---
1. Replit Agent 4（与标题最相关）← **全文第一篇！**

--- Hacker News ---
1. ... (该板块内与"Hacker News"最相关的)
2. ...

--- Product Hunt ---
1. Runner AI（与"AI/Agent"相关）
2. ...
